...
HD_PWD='C:/Users/Samuele/Desktop/vivado_xtea_syn/vivado_xtea_syn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xtea.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xtea.tcl
